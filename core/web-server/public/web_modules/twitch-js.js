...
function set (opts, logger, level, fallback) {
  ...
  logger[level] = logger.levelVal > logger.levels.values[level] ? noop$1
...
var errors_1 = errors.ParseError;
var errors_2 = errors.FormatError;
...
var helpers_1 = helpers.shouldEscapeString;
var helpers_2 = helpers.escapeString;
var helpers_3 = helpers.unescapeString;
...
function parseTags(input) {
    ...
    for (let i = 0; i < tagsLength; i += 1) {
        ...
        result[key] = value === undefined || helpers.unescapeString(value);
    }
    return result;
}
...
function parse(input) {
    ...
    if (input.charCodeAt(cursor) === 64) {
        if ((nextWhitespace = input.indexOf(" ")) === -1) {
            throw new errors.ParseError("Invalid Message");
        }
...
var parse_2 = parse_1.parseTags;
var parse_3 = parse_1.parsePrefix;
...
// TODO: Remove this for the next major release
var default_1$1 = camelCase;
camelcase.default = default_1$1;
...
const has$3 = (array, key) => array.some(x => {
	if (typeof x === 'string') {
		return x === key;
	}
 ...
 * // => 'fooBar'
 */
var camelCase$1 = _createCompounder(function(result, word, index) {
 ...
 * // => { 'a': 1, 'b': 2 }
 */
var defaults$2 = _baseRest(function(object, sources) {
  object = Object(object);
